...
require('includes/config.php');
 session_start();
	...
	$totalq="select count(*) \"total\" from book where b_id='$cat'";
									...
									<div class="entry">
										...
										<table border="4" width="100%" >
											...
											<?php
												...
												$query="select *from book where b_id='$cat' LIMIT ".$k .",".$page_per_page;
												...
												while($row=mysqli_fetch_assoc($res))
												{
													...
													echo '<td valign="top" width="20%" align="center">
														<a href="detail.php?id='.$row['b_id'].'&cat='.$_GET['b_cat'].'">
